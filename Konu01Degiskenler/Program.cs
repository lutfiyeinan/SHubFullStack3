...
// Değişkenler tiplerine göre bellekte stack ve heap denilen 2 ayrı bölümde saklanır.
// Değer tipli değişkenler stack alanında saklanırken referans tipli değişkenler heap bölümünde saklanır.
...
Console.WriteLine(birdegisken); // ctrl + d ile satırı çoğaltıyoruz
Console.WriteLine(birdegisken.GetType()); // GetType veri tipini verir
Console.WriteLine(birsayi);
...
object nesne = "bu bir nesnedir"; // Bu değişkenin türüne her türden veri atanabilir.
