...
namespace Konu06Diziler
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // dizi oluşturma
            // int[] sayi;
            int[] ogrenciler = new int[6]; // öğrenciler isminde int veri tipi taşıyan ve 6 elemandan oluşan bir dizi oluşturduk. Dizi boyutu artmaz , azalmaz.

            // Dizilerde indis (indeks) denilen yapı vardır ve içine eklenecek elemanlar 0 dan başlar.
            ogrenciler[0] = 100;
            ogrenciler[1] = 200;
            ogrenciler[2] = 300;
            ogrenciler[3] = 400;
            ...
            Console.WriteLine("ogrenciler [3]: " + ogrenciler2[3]);
            ogrenciler2[3] = 550;
            Console.WriteLine("ogrenciler [3]: " + ogrenciler2[3]);
