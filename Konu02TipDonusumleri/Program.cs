...
namespace Konu02TipDonusumleri
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Implicit Casting de daha küçük boyutlu bir türü daha büyük bir boyut türüne" +
                "geçirirken dönüşüm otomatik yapılır");
            int sayi = 18;
            ...
            Console.WriteLine(Convert.ToString(tamSayi2).GetType()); // tamSayi2 yi stringe çevir ve tipini doğrulamak için ekrana yazdır.
